execute as @e[type=arrow,nbt={inGround:1b}] run scoreboard players add @e[tag=NoLag] clearCount 1
execute as @e[type=spectral_arrow,nbt={inGround:1b}] run scoreboard players add @e[tag=NoLag] clearCount 1
